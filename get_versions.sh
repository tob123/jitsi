...
JITSI_LATEST_MJ=`echo $LATEST | sed s/.[0-9]*$//`
COTURN_VERSION=`curl -s https://git.alpinelinux.org/aports/plain/community/coturn/APKBUILD?h=3.13-stable | grep ^pkgver | awk -F '=' {'print $2'}`
